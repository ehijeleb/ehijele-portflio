...
const SKILLS = [
  { name: 'Python',       src: '/icons/skills/python.svg' },
  { name: 'JavaScript',   src: '/icons/skills/javascript.png' },
  { name: 'TypeScript',   src: '/icons/skills/typescript.svg' },
  { name: 'React',        src: '/icons/skills/react.svg' },
  { name: 'Next.js',      src: '/icons/skills/nextjs.svg' },
  { name: 'PostgreSQL',   src: '/icons/skills/postgresql.svg' },
  { name: 'Tailwind CSS', src: '/icons/skills/tailwind.svg' },
  { name: 'Git',          src: '/icons/skills/git.svg' },
  { name: 'HTML',         src: '/icons/skills/html.svg' },
];
      ...
      >
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {articles.map((article, i) => (
              ...
              >
                ...
                <h3 className="font-semibold text-white group-hover:text-treasure transition-colors mb-3 leading-snug line-clamp-2">
                  {article.title}
                </h3>
          ...
          >
            ...
            <span className="text-treasure text-xl">→</span>
          </motion.a>
        )}
      </motion.div>
    </section>
...
function Home() {
  ...
  // Pause expensive hero animations once it scrolls out of view
  const heroInView = useInView(heroRef, { amount: 0.1 });

  // Scroll-linked parallax for hero content (disabled for reduced-motion)
  ...
  return (
    ...
    >
      ...
      <section
        ref={heroRef}
        id="main"
        className="relative flex items-center justify-center min-h-[92vh] overflow-hidden pt-28"
      ...
      >
        ...
        {/* Ambient glow blobs — drift slowly (only while hero is on-screen) */}
        {heroInView && !reduce && (
        ...
        {/* Floating particles — rise like sea foam (paused when off-screen / reduced-motion) */}
        {heroInView && !reduce && (
          <div className="absolute inset-0 pointer-events-none overflow-hidden" aria-hidden="true">
            {PARTICLES.map((p, i) => (
              <div
                key={i}
                className="absolute bottom-0 rounded-full bg-treasure"
                style={{
                  left: `${p.x}%`,
                  width: p.size,
                  height: p.size,
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none select-none" aria-hidden="true">
          <div style={!reduce ? { animation: 'bob 7s 0.5s ease-in-out infinite' } : undefined}>
            <JollyRoger
              variant="watermark"
        ...
        <motion.div
          className="text-center px-6 sm:px-8 z-10 max-w-4xl mx-auto"
        ...
        >
          ...
          >
            <motion.p
              className="text-treasure font-mono text-xs tracking-[0.35em] uppercase mb-6"
              variants={fadeUp}
            >
              Software Engineer
            </motion.p>
            ...
            <motion.h1
              className="font-display text-5xl lg:text-7xl font-black text-white mb-6 leading-tight"
            ...
            <motion.p
              className="text-slate-400 text-lg lg:text-xl max-w-xl mx-auto mb-10 leading-relaxed"
              variants={fadeUp}
            >
              CS student at the University of Exeter. I build full-stack apps, ML side-projects,
              and the occasional thing nobody asked for.
            </motion.p>
            ...
            >
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 px-5 py-2.5 bg-white/5 hover:bg-treasure/10 border border-white/10 hover:border-treasure/40 rounded-lg transition-all duration-200 text-sm font-medium text-slate-300 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-treasure/70"
              >
                <img
                  src="/icons/skills/linkedin.png"
                  alt=""
                  aria-hidden="true"
                  className="w-4 h-4"
                />
        ...
        <div className="absolute bottom-0 left-0 right-0 overflow-hidden" style={{ height: 88 }} aria-hidden="true">
          {/* Back layer — ocean cyan, slowest */}
          <div className="absolute bottom-0 w-[200%]" style={!reduce ? { animation: 'wave-back 11s ease-in-out infinite' } : undefined}>
          ...
          <div className="absolute bottom-0 w-[200%]" style={!reduce ? { animation: 'wave-mid 8s ease-in-out infinite' } : undefined}>
            <svg viewBox="0 0 2880 88" xmlns="http://www.w3.org/2000/svg" className="w-full block">
              <path
          ...
          <div className="absolute bottom-0 w-[200%]" style={!reduce ? { animation: 'wave-front 6s ease-in-out infinite' } : undefined}>
            <svg viewBox="0 0 2880 88" xmlns="http://www.w3.org/2000/svg" className="w-full block">
              <path
      ...
      <div className="bg-base">
        ...
        {/* About */}
        <section className="max-w-5xl mx-auto px-6 sm:px-8 py-20" aria-labelledby="about-heading">
          <motion.div
            initial={{ opacity: 0, y: 28 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
          >
            <p className="text-xs font-mono text-treasure tracking-[0.3em] uppercase mb-3">About</p>
            <h2 id="about-heading" className="font-display text-3xl lg:text-4xl font-bold text-white mb-6">Who am I?</h2>
        ...
        {/* Skills */}
        <section className="max-w-5xl mx-auto px-6 sm:px-8 py-20 border-t border-slate-800" aria-labelledby="skills-heading">
          <motion.div
            initial={{ opacity: 0 }}
          ...
          >
            <p className="text-xs font-mono text-treasure tracking-[0.3em] uppercase mb-3">Skills</p>
            <h2 id="skills-heading" className="font-display text-3xl lg:text-4xl font-bold text-white mb-12">My Toolkit</h2>
              ...
              {SKILLS.map(({ name, src }, i) => (
                <li key={name}>
                  ...
                  >
                    ...
                    <span className="text-xs text-slate-500 group-hover:text-treasure font-medium transition-colors duration-200">
                      {name}
                    </span>
                  </motion.div>
                </li>
        ...
        {/* Featured Project */}
        {featured && (
          <section className="max-w-5xl mx-auto px-6 sm:px-8 py-20 border-t border-slate-800" aria-labelledby="featured-heading">
            <motion.div
              initial={{ opacity: 0, y: 28 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              transition={{ duration: 0.6 }}
            >
              <p className="text-xs font-mono text-treasure tracking-[0.3em] uppercase mb-3">Featured</p>
              <h2 id="featured-heading" className="font-display text-3xl lg:text-4xl font-bold text-white mb-10">Latest Work</h2>
              <motion.a
                href="/projects"
              ...
              >
                <div className="flex flex-col md:flex-row">
                  <div className="md:w-2/5 h-56 overflow-hidden bg-slate-700 flex-shrink-0">
                    {!featuredImgError ? (
                      ...
                      <div className="w-full h-full flex items-center justify-center">
                        <span className="text-slate-600 text-6xl font-black" aria-hidden="true">
                  ...
                  <div className="p-8 flex flex-col justify-center md:w-3/5">
                    <span className="text-xs font-mono text-treasure tracking-widest uppercase mb-3">
                      Featured Project
                    </span>
                    <h3 className="font-display text-2xl font-bold text-white mb-3 group-hover:text-amber-50 transition-colors">
                      {featured.title}
                    </h3>
